...
const UserLayout = ({ children }) => {
  ...
  return (
    <>
      <div className="flex items-center justify-between h-[4.75rem] w-full md:max-w-[1300px] lg:max-w-[1500px] xl:max-w-[1750px] px-4 md:px-8 py-2 md:py-4 lg:px-[5%] lg:py-4 xl:px-[10%] mx-auto border-b border-gray-100" style={{}}>
        <Link to='/'><h1 className='font-bold text-2xl' onClick={() => navigate('/orders')}>TransportEase</h1></Link>
