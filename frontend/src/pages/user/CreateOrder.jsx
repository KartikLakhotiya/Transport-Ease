...
const CreateOrder = () => {
  ...
  const handleOrderSubmit = (e) => {
    ...
    // /api/v1/orders
    fetch('https://transport-ease-6oqh.onrender.com/api/v1/orders/place-order', options)
  ...
  return (
    <UserLayout>
      ...
      <form onSubmit={handleOrderSubmit} className='grid grid-cols-2 gap-4 mt-4'>
        ...
        <button
          type='submit'
          class="w-max mt-6 flex flex-end bg-[#2756ff] text-white shadow-sm rounded-md border px-4 py-2 text-sm font-medium focus:relative"
        >
          {
